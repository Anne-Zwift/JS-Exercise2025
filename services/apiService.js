...
async function apiFetch(endpoint, options = {}) {
  ...
  const headers = {
    'Content-Type': 'application/json',
      'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiQW5uZVp3aWZ0IiwiZW1haWwiOiJhbm5tYXQwMDA3NUBzdHVkLm5vcm9mZi5ubyIsImlhdCI6MTc1NzU5MzAyM30.0ePpQ9bH-K0rdYjUTFk_NIst3ITU7pcJpzDoF5ypA68',
